...
void main(){
    ...
    modelPos += vec4(10.0 * uVelocity * uDTime.y, 0.0) + vec4(0.0, 2.0 * uVelocity.y / sqrt(dot(uVelocity.xz, uVelocity.xz)) * aPosition.z, 0.0, 0.0) - vec4(0.0, 5.0 * uDTime.y * uDTime.y * multiplier * multiplier, 0.0, 0.0);
